...
// Support is collected directly via UPI (QR code / UPI ID) — see UpiSupport,
// which owns the plans, the payer form, and the QR. There is no payment gateway
// integration; PaymentTab simply hosts that flow in the footer panel.
