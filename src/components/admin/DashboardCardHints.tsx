...
const HINTS: Record<string, string> = {
  ...
  subscriptions: 'Legacy reader/patron subscriptions (from the retired Razorpay integration).',
  transactions: 'Legacy revenue ledger (from the retired Razorpay integration).',
  payments: 'Legacy payment records tied to subscriptions (Razorpay integration retired).',
